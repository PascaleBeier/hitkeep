...
@Component({
    ...
    standalone: true,
    imports: [ReactiveFormsModule, NgOptimizedImage, ButtonModule, ConfirmDialogModule, IconFieldModule, InputIconModule, InputTextModule, MessageModule, SelectModule, TableModule, CopyControl, CrudDialog, RelativeDateTime, TableRowActions, TranslocoPipe],
