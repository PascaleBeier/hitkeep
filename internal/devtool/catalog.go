...
var gates = []Gate{
	...
	{ID: "developer-docs", Description: "Check CLI, release and configuration metadata, canonical skill packs, analytics procedures, and documentation drift", CIGroup: "go-checks", Command: []string{"go", "test", "./internal/devtool", "./skills"}, Profiles: []string{"pr", "full"}, Paths: []string{"AGENTS.md", "CONTRIBUTING.md", "README.md", "Dockerfile", "compose.yaml", "compose.cluster.yaml", "compose.dev.yaml", "examples/", ".agents/", ".codex/", ".github/workflows/", ".release-please-manifest.json", "release-please-config.json", "server.json", "skills/", "internal/config/", "internal/devtool/", "frontend/dashboard/package.json", "frontend/dashboard/package-lock.json", "charts/hitkeep/"}, Weight: 1, Timeout: "5m"},
	...
	{ID: "zizmor", Description: "Audit GitHub Actions workflows", CIGroup: "zizmor", Command: []string{"zizmor", ".github/workflows"}, Profiles: []string{"pr", "full"}, Paths: []string{".github/workflows/"}, Weight: 1, Timeout: "10m"},
